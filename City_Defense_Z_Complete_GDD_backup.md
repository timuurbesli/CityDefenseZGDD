...
- **Food Cost:** Required supplies based on expedition duration
...
- **Input Abstraction:** Unified input handling supporting keyboard/mouse and touch interfaces
...
**Code Organization:**
- **Namespace Structure:** Organized code namespaces preventing naming conflicts and improving maintainability
...
- **Runtime Profiling:** Built-in performance monitoring and bottleneck identification
...
- **Base Generation:** 10 Resource per day (day 1), scaling +2 per day until day 10, then +1 per day
...
- **Damage Boost:** +50% damage for 30 seconds, critical for boss encounters
...
**Wave Composition Design:**
- **Early Waves (Days 1-5):** 10-20 zombies, single type, 30-45 second duration
...
- **Beginner Runs (0-5 attempts):** 5-15 days average survival
...
**NPC Acquisition Timeline:**
- **First NPC Choice:** Day 5 of first successful run
...
**Map 1 (Nevada) - Learning Curve:**
- **Zombie Density:** 10-30 zombies per wave maximum
...
- **Casual Mode:** -25% enemy health and damage, +25% resource generation
...
**Testing Methodology:**
- **Statistical Analysis:** Data-driven balance adjustments based on player performance metrics
...
**Phase 1: Foundation Tutorial (Days 1-3)**

**First Day Tutorial:**
- **Basic Placement:** Learn building card selection and grid placement mechanics
...
**Phase 3: Meta Systems Tutorial (Days 8-15)**

**Research Point Systems:**
- **Laboratory Introduction:** Understanding meta progression currency
...
**Adaptive Guidance:**
- **Skill Detection:** Tutorial adapts pace based on player performance and comprehension
...
- **Experience Bars:** Clear visual representation of advancement toward next milestone
...
- **Strategy Sharing:** Platforms for players to share successful base designs and strategies
...
**Map Variety & Progression:**
- **Environmental Diversity:** Each map requires different tactical approaches and strategies
...
- **Mechanical Mastery:** Improving at real-time decision making and multitasking
...
- **Sunk Cost Engagement:** Research Point investment creates psychological commitment
...
- **Map 1 (Nevada):** Top 10 players + player's current ranking (e.g., "#2323")
...
**Top 10 Display:**
- **Rank Position:** Clear numerical ranking (#1, #2, #3, etc.)
...
**Ranking Incentives:**
- **Elite Recognition:** Top 10 positions provide significant prestige within community
...
- **Background:** Players of Bloons TD, Plants vs. Zombies, Kingdom Rush series
...
- **Unique Positioning:** "The thinking person's merge game" or "Tower defense with puzzle depth"
...
- **New Maps:** Additional environments with unique tactical challenges
...
- **Strategy Sharing:** Enhanced tools for base design and strategy communication
...
- **Viral Content Creation:** "I survived until day 1000" style content showcasing extreme survival achievements
...
**Premium Content Philosophy:**
- **Value-First Approach:** All paid content provides clear value without affecting game balance
...
- **Monthly Active Users:** Target 70% retention at 1 month, 40% at 6 months
